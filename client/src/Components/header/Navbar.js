...
export default function Navbar() {
    ...
    async function navData() {
        ...
        const checkRes = await axios.get("https://amazon-clone-sepia-rho.vercel.app/validuser",{withCredentials: true, credentials: 'include'})
    ...
    async function logOutUser() {
        ...
        const checkRes2 = await axios.get("https://amazon-clone-sepia-rho.vercel.app/logout",{withCredentials: true, credentials: 'include'})
        // console.log(checkRes.data.carts)
